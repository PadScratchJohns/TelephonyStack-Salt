#!/bin/bash
# Script to add any SINGULAR none partioned disks to the system and add to fstab to survive restarts. 
# Multiple disks require a logic tweak here. 
# Safe for production - mounts as data01 in the filesystem 
# setting vars
