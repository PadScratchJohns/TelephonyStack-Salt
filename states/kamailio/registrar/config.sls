...
# registrar Kamailio config files are kept here 
registrar_kamailio_config:
    file.managed:
...
registrar_kamailio_kemi_config:
    file.managed:
...
registrar_kamailio_default_file:
    file.managed:
